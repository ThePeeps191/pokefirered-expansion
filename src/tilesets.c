...
{
    {
        ...
        [SEASON_SPRING] = &gTileset_General,
        [SEASON_SUMMER] = &gTileset_General,
        [SEASON_AUTUMN] = &gTileset_General,
        [SEASON_WINTER] = &gTileset_General,
    },
    {
...
static const struct Tileset* const sSeasonTilesetsSecondary[][SEASON_WINTER + 1] =
{
    ...
    {
        [SEASON_SPRING] = &gTileset_PalletTown,
        [SEASON_SUMMER] = &gTileset_PalletTown,
        [SEASON_AUTUMN] = &gTileset_PalletTown,
        [SEASON_WINTER] = &gTileset_PalletTown,
    },
    {
        [SEASON_SPRING] = &gTileset_ViridianForest,
        [SEASON_SUMMER] = &gTileset_ViridianForest,
        [SEASON_AUTUMN] = &gTileset_ViridianForest,
        [SEASON_WINTER] = &gTileset_ViridianForest,
    },
    {
        [SEASON_SPRING] = &gTileset_LavenderTown,
        [SEASON_SUMMER] = &gTileset_LavenderTown,
        [SEASON_AUTUMN] = &gTileset_LavenderTown,
        [SEASON_WINTER] = &gTileset_LavenderTown,
    },
    {
        [SEASON_SPRING] = &gTileset_SaffronCity,
        [SEASON_SUMMER] = &gTileset_SaffronCity,
        [SEASON_AUTUMN] = &gTileset_SaffronCity,
        [SEASON_WINTER] = &gTileset_SaffronCity,
    },
    {
        [SEASON_SPRING] = &gTileset_CeladonCity,
        [SEASON_SUMMER] = &gTileset_CeladonCity,
        [SEASON_AUTUMN] = &gTileset_CeladonCity,
        [SEASON_WINTER] = &gTileset_CeladonCity,
    },
    {
        [SEASON_SPRING] = &gTileset_FuchsiaCity,
        [SEASON_SUMMER] = &gTileset_FuchsiaCity,
        [SEASON_AUTUMN] = &gTileset_FuchsiaCity,
        [SEASON_WINTER] = &gTileset_FuchsiaCity,
    },
    {
        [SEASON_SPRING] = &gTileset_IndigoPlateau,
        [SEASON_SUMMER] = &gTileset_IndigoPlateau,
        [SEASON_AUTUMN] = &gTileset_IndigoPlateau,
        [SEASON_WINTER] = &gTileset_IndigoPlateau,
    },
    {
        [SEASON_SPRING] = &gTileset_SeviiIslands123,
        [SEASON_SUMMER] = &gTileset_SeviiIslands123,
        [SEASON_AUTUMN] = &gTileset_SeviiIslands123,
        [SEASON_WINTER] = &gTileset_SeviiIslands123,
    },
    {
        [SEASON_SPRING] = &gTileset_BerryForest,
        [SEASON_SUMMER] = &gTileset_BerryForest,
        [SEASON_AUTUMN] = &gTileset_BerryForest,
        [SEASON_WINTER] = &gTileset_BerryForest,
    },
    SEASON_TILESETS_TERMINATOR
};
